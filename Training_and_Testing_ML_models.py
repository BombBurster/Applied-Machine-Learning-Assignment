...
print('Logistic Regressor 1 st principles: ', log_1_accuracy, ', ', log_1_precision, ', ', log_1_recall, ', ', log_1_f1_score)
...
RF_1_accuracy, RF_1_precision, RF_1_recall, RF_1_f1_score = cross_validation_RF_1(RandomForestRegressor(n_estimators=1000), 5, dataset, 'Absenteeism time in hours')
